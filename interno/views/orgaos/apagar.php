      		...
      		<div class="row-fluid">        	
        		<div class="span12">
        			...
        			<div class="page-header">
        				<h1>
        					Apagando órgão #<?=$codigo?>
        				</h1>
        			</div>
        			
          			<form class="form-horizontal" action="/orgaos/apagar/<?=$codigo?>" method="post">
          				<fieldset>
          					
          					<div class="control-group">
          						<div class="controls">
          							<p>Você deseja realmente deletar o órgão #<?=$codigo?>?</p>
          						</div>
          					</div>
          					...
          					<div class="form-actions">
          						...
          						<a href="/orgaos/listar" class="btn btn-success"><i class="icon-ok icon-white"></i> Não</a>
