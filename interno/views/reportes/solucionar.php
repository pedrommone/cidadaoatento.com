      		...
      		<div class="row-fluid">        	
        		<div class="span12">
        			<ul class="breadcrumb">
        				...
        				<li><li class="active">Solucionar</li></li>
        			</ul>
        			
        			<div class="page-header">
        				<h1>
        					Solucionando reporte #<?=$codigo?>
        				</h1>
        			</div>
        			
          			<form class="form-horizontal" action="/reportes/solucionar/<?=$codigo?>" method="post">
          				<fieldset>          					
          					<div class="control-group">
          						<div class="controls">
          							<p>Você deseja realmente solucionar o reporte #<?=$codigo?>?</p>
          						</div>
          					</div>
