	...
	<body>
		<div data-role="page" id="home">
            <div data-role="content">
                ...
                <form action="/mobile/enviar" method="post">
                	<div data-role="fieldcontain">
						<label for="select-choice-1" class="select">Tipo de problema</label>
						<select name="select-choice-1" id="select-choice-1" disabled>
							<option></option>
