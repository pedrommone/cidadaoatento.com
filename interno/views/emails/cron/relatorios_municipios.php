	...
	<body>		
		<div class="container">
    		...
    		<div class="page-header">
				<h1><?=ucwords($municipio->municipio)?> - <?=strtoupper($municipio->uf)?> <small>Relatório gerado automáticamente em <?=date('d/m/y')?> as <?=date('h:i')?> horas.</small></h1>
			
				<p>
  					Todos os problemas não solucionados foram anexados à este email.
  				</p>
			</div>  			
  			...
  			<p>
  				Para visualizar o relatório completo, faça login no <a href="http://sup.cidadaoatento.com">Sistema unificado de Prefeituras (SUP)</a>.
  			</p>
