      		...
      		<div class="row-fluid">        	
        		<div class="span12">
        			<ul class="breadcrumb">
        				...
        				<li><li class="active">Invalidar</li></li>
        			</ul>
        			
        			<div class="page-header">
        				<h1>
        					Invalidando denúncia #<?=$codigo?>
        				</h1>
        			</div>
        			
          			<form class="form-horizontal" action="/denuncias/invalidar/<?=$codigo?>" method="post">
          				<fieldset>
          					
          					<div class="control-group">
          						<div class="controls">
          							<p>Você deseja realmente invalidar a denúncia #<?=$codigo?>?</p>
          						</div>
          					</div>
