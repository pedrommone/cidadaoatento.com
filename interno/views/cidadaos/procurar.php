...
?>
      		<div class="row-fluid">        	
        		<div class="span12">
        			...
        			<div class="row-fluid">		          		
		          		<div class="span6">
		          			<form class="form-horizontal" action="/cidadaos/avancada" method="post">
		          				<fieldset>
		          					<div class="control-group">
		          						<label class="control-label" for="cpf">CPF</label>
		          						<div class="controls">
		          							<input type="text" class="input-xlarge" id="cpf" name="cpf" maxlength="45">
		          							<p class="help-block">CPF do cidadão.</p>
		          						</div>
		          					</div>
		          					...
		          					<div class="control-group">
		          						...
		          						<div class="controls">
		          							<input type="text" class="input-xlarge" id="telefone" name="telefone" maxlength="45">
		          							<p class="help-block">Telefone do cidadão.</p>
		          						</div>
		          					</div>
