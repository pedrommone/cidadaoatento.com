      		...
      		<div class="row-fluid">        	
        		<div class="span12">
        			<ul class="breadcrumb">
        				...
        				<li><li class="active">Bloquear</li></li>
        			</ul>
        			
        			<div class="page-header">
        				<h1>
        					Bloqueando cidadão de CPF <?=mask($cpf, MASK_CPF)?>
        				</h1>
        			</div>
        			
          			<form class="form-horizontal" action="/cidadaos/bloquear/<?=$cpf?>" method="post">
          				<fieldset>
          					
          					<div class="control-group">
          						<div class="controls">
          							<p>Você deseja realmente bloquear o cidadão de CPF #<?=mask($cpf, MASK_CPF)?>?</p>
          						</div>
          					</div>
