	...
	<body>		
		<div class="container">
    		...
    		<div class="page-header">			
  			...
  			<div class="span12">
  				<div class="alert alert-block <?=avisosLayout($tipo)?>">
	            	<p><?=$aviso?></p>
				</div>
  			</div>
  			
  			<p>
  				Você está recebendo este aviso porque assinou o mesmo. De deseja cancelar esta assinatura loge-se no seu painel.
  			</p>
