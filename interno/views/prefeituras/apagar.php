      		...
      		<div class="row-fluid">        	
        		<div class="span12">
        			<ul class="breadcrumb">
        				...
        				<li><li class="active">Apagar</li></li>
        			</ul>
        			
        			<div class="page-header">
        				<h1>
        					Apagando prefeitura #<?=$codigo?>
        				</h1>
        			</div>
        			
          			<form class="form-horizontal" action="/prefeituras/apagar/<?=$codigo?>" method="post">
          				<fieldset>
          					
          					<div class="control-group">
          						<div class="controls">
          							<p>Você deseja realmente deletar a prefeitura #<?=$codigo?>?</p>
          						</div>
          					</div>
          					...
          					<div class="form-actions">
          						...
          						<a href="/prefeituras/listar" class="btn btn-success"><i class="icon-ok icon-white"></i> Não</a>
