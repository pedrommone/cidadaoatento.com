      		...
      		<div class="row-fluid">        	
        		<div class="span12">
        			<ul class="breadcrumb">
        				...
        				<li><li class="active">Verificar</li></li>
        			</ul>
        			
        			<div class="page-header">
        				<h1>
        					Verificando denúncia #<?=$codigo?>
        				</h1>
        			</div>
        			
          			<form class="form-horizontal" action="/denuncias/verificar/<?=$codigo?>" method="post">
          				<fieldset>
          					
          					<div class="control-group">
          						<div class="controls">
          							<p>Você deseja realmente veficicar a denúncia #<?=$codigo?>?</p>
          						</div>
          					</div>
