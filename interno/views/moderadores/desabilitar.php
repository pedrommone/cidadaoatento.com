      		...
      		<div class="row-fluid">        	
        		<div class="span12">
        			<ul class="breadcrumb">
        				...
        				<li><li class="active">Desabilitar</li></li>
        			</ul>
        			
        			<div class="page-header">
        				<h1>
        					Desabilitando moderador #<?=$codigo?>
        				</h1>
        			</div>
        			
          			<form class="form-horizontal" action="/moderadores/desabilitar/<?=$codigo?>" method="post">
          				<fieldset>
          					
          					<div class="control-group">
          						<div class="controls">
          							<p>Você deseja realmente desabilitar o moderador #<?=$codigo?>?</p>
          						</div>
          					</div>
