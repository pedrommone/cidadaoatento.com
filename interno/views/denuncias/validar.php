      		...
      		<div class="row-fluid">        	
        		<div class="span12">
        			<ul class="breadcrumb">
        				...
        				<li><li class="active">Validar</li></li>
        			</ul>
        			
        			<div class="page-header">
        				<h1>
        					Validando denúncia #<?=$codigo?>
        				</h1>
        			</div>
        			
          			<form class="form-horizontal" action="/denuncias/validar/<?=$codigo?>" method="post">
          				<fieldset>
          					
          					<div class="control-group">
          						<div class="controls">
          							<p>Você deseja realmente validar a denúncia #<?=$codigo?>?</p>
          						</div>
          					</div>
